...
// Correct landmark images for each city
const META: Record<string, { img: string; tag: string; tagClass: string }> = {
  BOM: {
    img: "https://images.unsplash.com/photo-1570168007204-dfb528c6958f?w=600&q=80&auto=format&fit=crop", // Gateway of India / Marine Drive
    tag: "Popular",
    tagClass: "badge-red"
  },
  GOI: {
    img: "https://images.unsplash.com/photo-1587922546307-776227941871?w=600&q=80&auto=format&fit=crop",
    tag: "Beach",
    tagClass: "badge-black"
  },
  BLR: {
    img: "https://images.unsplash.com/photo-1596176530529-78163a4f7af2?w=600&q=80&auto=format&fit=crop", // Bengaluru skyline / Vidhana Soudha
    tag: "Tech",
    tagClass: "badge-off"
  },
  MAA: {
  ...
  HYD: {
    img: "https://images.unsplash.com/photo-1598091383021-15ddea10925d?w=600&q=80&auto=format&fit=crop", // Charminar
    tag: "Pearls",
    tagClass: "badge-black"
  },
  CCU: {
...
const FALLBACK_IMG = "https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=600&q=80&auto=format&fit=crop";
...
export default function PopularDestinations() {
  ...
  if (loading) {
    return (
      <div className="dest-grid">
        {[0, 1, 2].map(i => (
          <div key={i} className="dest-card" style={{ cursor: "default" }}>
  ...
  return (
    <div className="dest-grid">
      {data.map(r => {
        const m = META[r.destination_code] || { img: FALLBACK_IMG, tag: "Trending", tagClass: "badge-off" };
          ...
          <Link key={`${r.origin_code}-${r.destination_code}`} href={url} className="dest-card">
            ...
            <div className="dest-body">
              ...
              <div className="dest-meta">
                ...
                <div style={{ marginLeft: "auto", fontSize: ".68rem", color: "var(--grey3)", fontFamily: "var(--fm)" }}>
