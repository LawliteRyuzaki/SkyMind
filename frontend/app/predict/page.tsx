...
export default function PredictPage() {
  ...
  // Pre-fill alert price when result arrives
  useEffect(() => {
    if (result) {
            ...
            <div style={{ order: 2 }}>
              ...
              <div className="chart-area" style={{ marginBottom: "16px" }}>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  {/* FIXED: Return date only shown for ROUND_TRIP */}
              ...
              {result && (
                <>
                  ...
                  <div className="stat-trio" style={{ marginBottom: "16px" }}>
                    <div className="stat-trio-item">
                      ...
                      <div style={{ display: "inline-flex", alignItems: "center", padding: "5px 12px", fontWeight: 700, fontSize: ".88rem", letterSpacing: ".04em", ...recStyle(result.recommendation) }}>
                        {/* FIXED: "BOOK NOW" not "BOOK_NOW" */}
                        {formatRec(result.recommendation)}
                      </div>
                    </div>
                    {/* FIXED: probability as percentage */}
                    <div className="stat-trio-item">
                    ...
                    {/* FIXED: confidence as percentage */}
                    <div className="stat-trio-item">
                  ...
                  {/* 30-day forecast chart — uses REAL data from API */}
                  <div className="chart-area" style={{ marginBottom: "16px" }}>
                    ...
                    {/* FIXED: Chart uses result.forecast and result.trend */}
                ...
                <div className="rec-body">
                  {alerts.length === 0 ? (
                    ...
                    alerts.map((alert) => (
                      <div
                        key={alert.id}
                        style={{ padding: "10px 0", borderBottom: "1px solid var(--grey1)" }}
                      >
                        ...
                        {alert.triggered && (
                          <div style={{ fontSize: ".72rem", fontWeight: 700, color: "#166534", marginTop: "4px" }}>
