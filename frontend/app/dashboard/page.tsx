        ...
        <div className="dash-header">
          <div className="wrap">
            <div className="dash-title-row">
              <div>
                <div style={{ fontFamily: "var(--fm)", fontSize: ".62rem", fontWeight: 500, letterSpacing: ".14em", textTransform: "uppercase", color: "var(--grey3)", marginBottom: 10 }}>
            ...
            <div className="dash-grid">
              ...
              <div>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
                  ...
                  <span style={{ fontSize: ".72rem", color: "var(--grey3)", fontFamily: "var(--fm)" }}>{bookings.length} bookings</span>
                </div>

                {/* Skeletons */}
                {loading && [0, 1].map(i => (
                  <div key={i} className="booking-card" style={{ padding: 16, marginBottom: 10, cursor: "default" }}>
                ...
                {!loading && bookings.length === 0 && (
                  <div className="empty-state">
                    No bookings yet.{" "}
                    <Link href="/flights" style={{ color: "var(--red)", textDecoration: "underline" }}>Search flights</Link>
                    {" "}to get started.
                  </div>
                )}
                ...
                {!loading && bookings.map((b, i) => (
                  <div key={b.id} className="booking-card"
                    style={{ borderColor: i === 0 ? "var(--black)" : undefined, animation: `fadeUp .35s ${i * 0.07}s ease both` }}
                    ...
                    <div className="bk-body">
                      ...
                      <div className="bk-foot">
                        <span style={{ color: "var(--grey3)", fontFamily: "var(--fm)", fontSize: ".68rem" }}>
                          {b.created_at ? new Date(b.created_at).toLocaleDateString("en-IN") : "--"}
                        </span>
                        <span style={{ fontFamily: "var(--fd)", fontSize: "1.2rem", letterSpacing: ".03em" }}>
              ...
              <div>
                <div className="sidebar-card">
                  ...
                  {alerts.length === 0 && !loading && (
                    <div style={{ padding: "16px", fontSize: ".8rem", color: "var(--grey3)", textAlign: "center" }}>No alerts set yet.</div>
                  )}
                  {alerts.map(a => (
                  ...
                  <div style={{ padding: "12px 16px" }}>
                    <Link href="/predict" className="btn-outline" style={{ width: "100%", justifyContent: "center", fontSize: ".78rem", padding: "9px" }}>
                      + Add alert
                    </Link>
                  </div>
                </div>
                ...
                <div className="sidebar-card">
                  ...
                  {[
                    ...
                    <Link key={q.label} href={q.href} className="qa-item"
                      style={{ borderBottom: i < arr.length - 1 ? undefined : "none" }}>
                      <div style={{ width: 28, height: 28, background: "var(--off)", border: "1px solid var(--grey1)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                        {q.icon}
                      </div>
                      {q.label}
                    </Link>
